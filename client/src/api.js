...
export async function createAuftrag({ auftragsnr, kunde, beschreibung }) {
  const res = await fetch(`${API_BASE}/auftraege`, {
    method: "POST",
...
export async function vorgangFertigMelden(auftragId, vorgangId, user) {
...
export async function vorgangBestaetigen(auftragId, vorgangId, bestaetigt, user) {
  const res = await fetch(
